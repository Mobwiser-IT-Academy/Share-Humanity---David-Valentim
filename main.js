var issues = [
    ...
    {title: '3. Health', info: `    Ensuring healthy lives and promoting the well-being at all ages is essential to sustainable development.
    ...
    {title: '4. Education', info: `    Obtaining a quality education is the foundation to creating sustainable development. In addition to improving quality of life, access to inclusive education can help equip locals with the tools required to develop innovative solutions to the world’s greatest problems.
...
var issueContainer = [document.getElementById('issue-1'),document.getElementById('issue-2'),document.getElementById('issue-3'),document.getElementById('issue-4'),document.getElementById('issue-5')];

var issueTitle = [document.getElementById('first-issue'),document.getElementById('second-issue'),document.getElementById('third-issue'),document.getElementById('fourth-issue'),document.getElementById('fifth-issue')];
...
var issueInfo = [document.getElementById('first-issue-info'),document.getElementById('second-issue-info'),document.getElementById('third-issue-info'),document.getElementById('fourth-issue-info'),document.getElementById('fifth-issue-info')];
...
var affected = [document.getElementById('people-affected-1'),document.getElementById('people-affected-2'),document.getElementById('people-affected-3'),document.getElementById('people-affected-4'),document.getElementById('people-affected-5')];
...
var filter = document.getElementById('dropdown');
...
function filterFunction() {
    ...
    for (i = 0; i < li.length; i++) {
      item = li[i].getElementsByClassName("item")[0];
...
function filterFunctionDetails() {
    // Declare variables
